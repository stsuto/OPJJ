...
/**
 * Class {@code IntegerStorage} is the Subject of the observer pattern. It
 * represents a storage of one integer value which can't be then used with some
 * observer objects.
 * 
 * @author stipe
 *
...
public class IntegerStorage {
	...
	/**
	 * Observers that were observing this storage during the last modification. Used
	 * for concurrent modification of observer list.
	 */
