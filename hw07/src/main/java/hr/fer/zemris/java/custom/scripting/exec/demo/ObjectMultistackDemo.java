...
/**
 * This class is an example of the functionality of {@link ObjectMultistack}.
 * In it is shown the independence of each stack mapped to their own key and
 * the arithmetic operations performed upon {@link ValueWrapper} objects.
 * 
 * @author stipe
 *
 */
