 ...
 * simplification of a ray-tracer for rendering of 3D scenes. <p>
	...
	private static IRayTracerProducer getIRayTracerProducer() {
		return new IRayTracerProducer() {
			...
			public void produce(Point3D eye, Point3D view, Point3D viewUp, 
				...
				pool.invoke(new RayCasterJob(screenCorner, xAxis, yAxis, eye, scene, red, green, 
						blue, horizontal, vertical, width, height, 0, height - 1, cancel));
				pool.shutdown();
