...
public class Vector2D {
	...
	public Vector2D translated(Vector2D offset) {
		Vector2D translatedVector = new Vector2D(this.x, this.y); // using "this" for clarity
	...
	public Vector2D rotated(double angle) {
		Vector2D rotatedVector = new Vector2D(this.x, this.y);
	...
	public Vector2D scaled(double scaler) {
		Vector2D scaledVector = new Vector2D(this.x, this.y);
